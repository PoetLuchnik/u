...
int    ys_free_array(const YS* ys, size_t arrsz);
...
int    ys_indexOf_from(const YS* ys, int i, YCHAR c);
int    ys_indexOf(const YS* ys, YCHAR c);
int    ys_countOf_from(const YS* ys, int i, YCHAR c);
int    ys_countOf(const YS* ys, YCHAR c);
YS     ys_substring(const YS* ys, int i, size_t len);
